...
mn <- mean(aggStepsPerDay$no_of_steps, na.rm = T)
md <- median(aggStepsPerDay$no_of_steps, na.rm = T)
```

Mean number of steps taken per day is `r mn` and median is `r mn`.
...
interval.with.highest.avg.steps <- aggStepsOverIntv[sel, ]
